                    ...
                    <form action="{{ route('admin.paket.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="nama_paket" class="block mt-1 w-full" type="text" name="nama_paket" :value="old('nama_paket')" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="kecepatan" class="block mt-1 w-full" type="text" name="kecepatan" :value="old('kecepatan')" placeholder="Contoh: 10 Mbps" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="harga_bulanan" class="block mt-1 w-full" type="number" name="harga_bulanan" :value="old('harga_bulanan')" min="0" step="1" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="harga_pemasangan" class="block mt-1 w-full" type="number" name="harga_pemasangan" :value="old('harga_pemasangan')" min="0" step="1" />
