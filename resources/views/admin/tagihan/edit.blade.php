                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.tagihan.update', $tagihan) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="pelanggan_id" name="pelanggan_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                    ...
                                    @foreach($pelanggan as $p)
                                        <option value="{{ $p->pelanggan_id }}" {{ old('pelanggan_id', $tagihan->pelanggan_id) == $p->pelanggan_id ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <select id="paket_id" name="paket_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                    ...
                                    @foreach($paket as $p)
                                        <option value="{{ $p->paket_id }}" {{ old('paket_id', $tagihan->paket_id) == $p->paket_id ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <select id="bulan" name="bulan" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                    ...
                                    @for($i = 1; $i <= 12; $i++)
                                        <option value="{{ $i }}" {{ old('bulan', $tagihan->bulan) == $i ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <x-text-input id="tahun" class="block mt-1 w-full" type="number" name="tahun" :value="old('tahun', $tagihan->tahun)" min="2020" max="2100" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="jumlah_tagihan" class="block mt-1 w-full" type="number" name="jumlah_tagihan" :value="old('jumlah_tagihan', $tagihan->jumlah_tagihan)" min="0" step="0.01" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="tanggal_jatuh_tempo" class="block mt-1 w-full" type="date" name="tanggal_jatuh_tempo" :value="old('tanggal_jatuh_tempo', $tagihan->tanggal_jatuh_tempo->format('Y-m-d'))" required />
                            ...
                            <div>
                                ...
                                <select id="jenis_tagihan" name="jenis_tagihan" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                    ...
                                    <option value="pemasangan" {{ old('jenis_tagihan', $tagihan->jenis_tagihan) === 'pemasangan' ? 'selected' : '' }}>Pemasangan</option>
                                    <option value="upgrade" {{ old('jenis_tagihan', $tagihan->jenis_tagihan) === 'upgrade' ? 'selected' : '' }}>Upgrade</option>
                                </select>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="keterangan" name="keterangan" rows="3" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('keterangan', $tagihan->keterangan) }}</textarea>
