                    ...
                    <form action="{{ route('admin.pelanggan.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="tanggal_pemasangan" class="block mt-1 w-full" type="date" name="tanggal_pemasangan" :value="old('tanggal_pemasangan', date('Y-m-d'))" required />
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-md p-4 mb-6">
                            <p class="text-sm text-blue-800">
                                <strong>Catatan:</strong> Setelah pelanggan dibuat, sistem akan otomatis membuat tagihan pemasangan pertama (harga pemasangan + harga paket bulan pertama).
                            </p>
                        </div>
